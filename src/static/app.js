document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-buttons">
        ...
        <button class="share-btn share-linkedin" data-activity="${escapeHtml(name)}" data-description="${escapeHtml(details.description)}" title="Share on LinkedIn">
  ...
  function handleShare(event) {
    ...
    // Construct the share URL (using the current page URL)
